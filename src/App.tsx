      ...
      {showSettings && (
        <div className="w-full max-w-lg mt-12 bg-white border border-slate-200 rounded-xl p-6 shadow-lg animate-in slide-in-from-top-4 duration-300 z-50">
          ...
          <p className="text-slate-600 text-sm mb-4 leading-relaxed">
            Your key is saved <strong>locally</strong> in your browser's LocalStorage. All AI operations are executed directly via client-side fetch
            calls to OpenAI.
          </p>
